...
template<>
WARN_UNUSED error_code document_parser_implementation::for_architecture<architecture::HASWELL>::stage1(const uint8_t *buf, size_t len, document::parser &parser, bool streaming) const noexcept {
